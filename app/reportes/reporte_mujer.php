...
session_start();
    ...
    $query = "SELECT Id_producto,Marca,modelo,Cantidad,Precio,Genero from producto INNER JOIN tipo_producto ON tipo_producto.Id_tipo_p=producto.tipo_producto_p AND producto.tipo_producto_p=2";
    $params = array(null);
