<div class="slider">
            <ul class="slides">
                <li>
                    ...
                    <h3 class=" pink-text accent-3">Zapatos de mujeres</h3>
                    </div>
                </li>
                ...
                <li>
                    ...
                    <h2 class=" pink-text darken-4">SLOGAN!</h2>
                    <h3 class=" pink-text accent-3">"Caminado hacia el futuro, con toda la comodidad del mundo".</h3>
                    </div>
                </li>
                <li>
