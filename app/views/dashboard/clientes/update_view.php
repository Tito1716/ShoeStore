...
<form method='post'>
        ...
        <input  id="usuario" type="text" name="usuario" class="validate" value='<?php print($Cliente->getNombres()) ?>' required>
        <label class="active" for="usuario">Usuario</label>
      </div>
                  <div class="input-field col s12 l6">
                    <input  id="apellido" type="text" name="apellido" class="validate" value='<?php print($Cliente->getApellidos()) ?>' required>
